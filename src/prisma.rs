...
pub mod logs {
    ...
    pub mod log_index {
        ...
        pub fn equals(value: i64) -> WhereParam {
            WhereParam::LogIndex(_prisma::read_filters::BigIntFilter::Equals(value))
        }
        ::prisma_client_rust::scalar_where_param_fns!(
            _prisma::read_filters::BigIntFilter,
            LogIndex,
        ...
        pub fn increment(value: i64) -> SetParam {
            SetParam::IncrementLogIndex(value)
        }
        pub fn decrement(value: i64) -> SetParam {
            SetParam::DecrementLogIndex(value)
        }
        pub fn multiply(value: i64) -> SetParam {
            SetParam::MultiplyLogIndex(value)
        }
        pub fn divide(value: i64) -> SetParam {
            SetParam::DivideLogIndex(value)
        }
        pub struct Include;
        impl Into<super::IncludeParam> for Include {
            fn into(self) -> super::IncludeParam {
    ...
    ) -> (String, i64, i64, String, Vec<u8>, Vec<SetParam>) {
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_logs { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: logs struct $ struct_name { # [serde (rename = "id")] pub id : String , # [serde (rename = "tx_hash")] pub tx_hash : String , # [serde (rename = "block_number")] pub block_number : i64 , # [serde (rename = "log_index")] pub log_index : i64 , # [serde (rename = "topics")] pub topics : Vec < String > , # [serde (rename = "address")] pub address : String , # [serde (rename = "data")] pub data : Vec < u8 > } [$ ($ scalar_field) , +] } } ; }
    ...
    pub enum SetParam {
        ...
        SetLogIndex(i64),
        IncrementLogIndex(i64),
        DecrementLogIndex(i64),
        MultiplyLogIndex(i64),
        DivideLogIndex(i64),
            ...
            let (name, value) = match self {
                ...
                Self::BlockNumberLogIndexEquals(block_number, log_index) => (
                    ...
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![
                        ...
                        (
                            log_index::NAME.to_string(),
                            ::prisma_client_rust::PrismaValue::BigInt(log_index),
                        ),
                    ]),
                ),
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create_many(
            self,
            data: Vec<(String, i64, i64, String, Vec<u8>, Vec<SetParam>)>,
        ) -> CreateMany<'a> {
            let data = data
                .into_iter()
                .map(
...
pub mod states {
    ...
    pub mod indexed_type {
        ...
        pub const NAME: &str = "indexed_type";
        pub struct Set(pub self::IndexedType);
        impl From<Set> for SetParam {
            fn from(Set(v): Set) -> Self {
                Self::SetIndexedType(v)
            }
        }
        impl From<Set> for UncheckedSetParam {
            fn from(Set(v): Set) -> Self {
        ...
        pub fn set<T: From<Set>>(value: self::IndexedType) -> T {
            Set(value).into()
        }
        pub fn order(direction: ::prisma_client_rust::Direction) -> OrderByParam {
            OrderByParam::IndexedType(direction)
        }
        pub fn equals(value: self::IndexedType) -> WhereParam {
            WhereParam::IndexedType(_prisma::read_filters::IndexedTypeFilter::Equals(value))
        }
        ::prisma_client_rust::scalar_where_param_fns!(
            _prisma::read_filters::IndexedTypeFilter,
            IndexedType,
            {
                fn in_vec(_: Vec<super::super::IndexedType>) -> InVec;
                fn not_in_vec(_: Vec<super::super::IndexedType>) -> NotInVec;
                fn not(_: super::super::IndexedType) -> Not;
            }
        );
        pub struct Include;
        impl Into<super::IncludeParam> for Include {
            fn into(self) -> super::IncludeParam {
                super::IncludeParam::IndexedType(self)
            }
        }
        impl Include {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
        ...
        impl Into<super::SelectParam> for Select {
            fn into(self) -> super::SelectParam {
                super::SelectParam::IndexedType(self)
            }
        }
        impl Select {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
    ...
    pub fn chain_indexed_type<T: From<UniqueWhereParam>>(
        chain: crate::prisma::Chain,
        indexed_type: crate::prisma::IndexedType,
    ) -> T {
        UniqueWhereParam::ChainIndexedTypeEquals(chain, indexed_type).into()
    }
    pub fn create(
        chain: super::Chain,
        indexed_type: super::IndexedType,
        indexed_block: i64,
        _params: Vec<SetParam>,
    ) -> (super::Chain, super::IndexedType, i64, Vec<SetParam>) {
        (chain, indexed_type, indexed_block, _params)
    }
    pub fn create_unchecked(
        chain: super::Chain,
        indexed_type: super::IndexedType,
    ...
    #[macro_export]
    macro_rules ! _select_states { ($ (($ ($ func_arg : ident : $ func_arg_ty : ty) , +) =>) ? $ module_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { # [allow (warnings)] pub mod $ module_name { crate :: prisma :: states :: select ! (@ definitions ; $ module_name ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; use super :: * ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: SelectType for Selection { type Data = Data ; type ModelData = crate :: prisma :: states :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } pub fn select ($ ($ ($ func_arg : $ func_arg_ty) , +) ?) -> Selection { Selection ([crate :: prisma :: states :: select ! (@ selections_to_params ; : select { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () ,] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } } ; ({ $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { { crate :: prisma :: states :: select ! (@ definitions ; ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: SelectType for Selection { type Data = Data ; type ModelData = crate :: prisma :: states :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } Selection ([crate :: prisma :: states :: select ! (@ selections_to_params ; : select { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () ,] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } ; (@ definitions ; $ ($ module_name : ident) ? ; $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) +) => { # [allow (warnings)] enum Fields { chain , indexed_type , indexed_block } # [allow (warnings)] impl Fields { fn selections () { $ (let _ = Fields :: $ field ;) + } } # [allow (warnings)] # [derive (std :: fmt :: Debug , Clone)] pub struct Data { $ (pub $ field : crate :: prisma :: states :: select ! (@ field_type ; $ field $ (: $ selection_mode { $ ($ selections) + }) ?) ,) + } impl :: serde :: Serialize for Data { fn serialize < S > (& self , serializer : S) -> Result < S :: Ok , S :: Error > where S : :: serde :: Serializer , { use :: serde :: ser :: SerializeStruct ; let mut state = serializer . serialize_struct ("Data" , [$ (stringify ! ($ field) ,) +] . len ()) ? ; $ (state . serialize_field (crate :: prisma :: states :: $ field :: NAME , & self . $ field) ? ;) * state . end () } } impl < 'de > :: serde :: Deserialize < 'de > for Data { fn deserialize < D > (deserializer : D) -> Result < Self , D :: Error > where D : :: serde :: Deserializer < 'de > , { # [allow (warnings)] enum Field { $ ($ field) , + , } impl < 'de > :: serde :: Deserialize < 'de > for Field { fn deserialize < D > (deserializer : D) -> Result < Field , D :: Error > where D : :: serde :: Deserializer < 'de > , { struct FieldVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for FieldVisitor { type Value = Field ; fn expecting (& self , formatter : & mut :: std :: fmt :: Formatter) -> :: std :: fmt :: Result { formatter . write_str (& [$ (crate :: prisma :: states :: $ field :: NAME) , + ,] . into_iter () . collect :: < Vec < _ >> () . join (", ")) } fn visit_str < E > (self , value : & str) -> Result < Field , E > where E : :: serde :: de :: Error , { match value { $ (crate :: prisma :: states :: $ field :: NAME => Ok (Field :: $ field)) , * , _ => Err (:: serde :: de :: Error :: unknown_field (value , FIELDS)) , } } } deserializer . deserialize_identifier (FieldVisitor) } } struct DataVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for DataVisitor { type Value = Data ; fn expecting (& self , formatter : & mut std :: fmt :: Formatter) -> std :: fmt :: Result { formatter . write_str ("struct Data") } fn visit_map < V > (self , mut map : V) -> Result < Data , V :: Error > where V : :: serde :: de :: MapAccess < 'de > , { $ (let mut $ field = None ;) * while let Some (key) = map . next_key () ? { match key { $ (Field :: $ field => { if $ field . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: states :: $ field :: NAME)) ; } $ field = Some (map . next_value () ?) ; }) * } } $ (let $ field = $ field . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: states :: $ field :: NAME)) ? ;) * Ok (Data { $ ($ field) , * }) } } const FIELDS : & 'static [& 'static str] = & ["chain" , "indexed_type" , "indexed_block"] ; deserializer . deserialize_struct ("Data" , FIELDS , DataVisitor) } } $ ($ (pub mod $ field { crate :: prisma :: states :: $ selection_mode ! (@ field_module ; $ field : $ selection_mode { $ ($ selections) + }) ; }) ?) + } ; (@ field_type ; chain) => { crate :: prisma :: Chain } ; (@ field_type ; indexed_type) => { crate :: prisma :: IndexedType } ; (@ field_type ; indexed_block) => { i64 } ; (@ field_type ; $ field : ident $ ($ tokens : tt) *) => { compile_error ! (stringify ! (Cannot include nonexistent relation $ field on model "States" , available relations are "chain, indexed_type, indexed_block")) } ; (@ field_module ; $ ($ tokens : tt) *) => { } ; (@ selection_field_to_selection_param ; chain) => { Into :: < crate :: prisma :: states :: SelectParam > :: into (crate :: prisma :: states :: chain :: Select) } ; (@ selection_field_to_selection_param ; indexed_type) => { Into :: < crate :: prisma :: states :: SelectParam > :: into (crate :: prisma :: states :: indexed_type :: Select) } ; (@ selection_field_to_selection_param ; indexed_block) => { Into :: < crate :: prisma :: states :: SelectParam > :: into (crate :: prisma :: states :: indexed_block :: Select) } ; (@ selection_field_to_selection_param ; $ ($ tokens : tt) *) => { compile_error ! (stringify ! ($ ($ tokens) *)) } ; (@ selections_to_params ; : $ macro_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { [$ (crate :: prisma :: states :: $ macro_name ! (@ selection_field_to_selection_param ; $ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) ,) +] } ; (@ filters_to_args ;) => { vec ! [] } ; (@ filters_to_args ; $ ($ t : tt) *) => { $ ($ t) * } ; (@ field_serde_name ; chain) => { "chain" } ; (@ field_serde_name ; indexed_type) => { "indexed_type" } ; (@ field_serde_name ; indexed_block) => { "indexed_block" } ; }
    pub use _select_states as select;
    pub enum SelectParam {
        Chain(chain::Select),
        IndexedType(indexed_type::Select),
    ...
    impl SelectParam {
        pub fn to_selection(self) -> ::prisma_client_rust::Selection {
            match self {
                ...
                Self::IndexedType(data) => data.to_selection(),
                Self::IndexedBlock(data) => data.to_selection(),
            }
        }
    }
    #[macro_export]
    macro_rules ! _include_states { ($ (($ ($ func_arg : ident : $ func_arg_ty : ty) , +) =>) ? $ module_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { # [allow (warnings)] pub mod $ module_name { crate :: prisma :: states :: include ! (@ definitions ; $ module_name ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; use super :: * ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = crate :: prisma :: states :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } pub fn include ($ ($ ($ func_arg : $ func_arg_ty) , +) ?) -> Selection { Selection ([crate :: prisma :: states :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < crate :: prisma :: states :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } } ; ({ $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { { crate :: prisma :: states :: include ! (@ definitions ; ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = crate :: prisma :: states :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } Selection ([crate :: prisma :: states :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < crate :: prisma :: states :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } ; (@ definitions ; $ ($ module_name : ident) ? ; $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) +) => { # [allow (warnings)] enum Fields { } # [allow (warnings)] impl Fields { fn selections () { $ (let _ = Fields :: $ field ;) + } } # [allow (warnings)] # [derive (std :: fmt :: Debug , Clone)] pub struct Data { pub chain : crate :: prisma :: Chain , pub indexed_type : crate :: prisma :: IndexedType , pub indexed_block : i64 , $ (pub $ field : crate :: prisma :: states :: include ! (@ field_type ; $ field $ (: $ selection_mode { $ ($ selections) + }) ?) ,) + } impl :: serde :: Serialize for Data { fn serialize < S > (& self , serializer : S) -> Result < S :: Ok , S :: Error > where S : :: serde :: Serializer , { use :: serde :: ser :: SerializeStruct ; let mut state = serializer . serialize_struct ("Data" , [$ (stringify ! ($ field) ,) + stringify ! (chain) , stringify ! (indexed_type) , stringify ! (indexed_block)] . len ()) ? ; $ (state . serialize_field (crate :: prisma :: states :: $ field :: NAME , & self . $ field) ? ;) * state . serialize_field (crate :: prisma :: states :: chain :: NAME , & self . chain) ? ; state . serialize_field (crate :: prisma :: states :: indexed_type :: NAME , & self . indexed_type) ? ; state . serialize_field (crate :: prisma :: states :: indexed_block :: NAME , & self . indexed_block) ? ; state . end () } } impl < 'de > :: serde :: Deserialize < 'de > for Data { fn deserialize < D > (deserializer : D) -> Result < Self , D :: Error > where D : :: serde :: Deserializer < 'de > , { # [allow (warnings)] enum Field { $ ($ field) , + , chain , indexed_type , indexed_block } impl < 'de > :: serde :: Deserialize < 'de > for Field { fn deserialize < D > (deserializer : D) -> Result < Field , D :: Error > where D : :: serde :: Deserializer < 'de > , { struct FieldVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for FieldVisitor { type Value = Field ; fn expecting (& self , formatter : & mut :: std :: fmt :: Formatter) -> :: std :: fmt :: Result { formatter . write_str (& [$ (crate :: prisma :: states :: $ field :: NAME) , + , crate :: prisma :: states :: chain :: NAME , crate :: prisma :: states :: indexed_type :: NAME , crate :: prisma :: states :: indexed_block :: NAME] . into_iter () . collect :: < Vec < _ >> () . join (", ")) } fn visit_str < E > (self , value : & str) -> Result < Field , E > where E : :: serde :: de :: Error , { match value { $ (crate :: prisma :: states :: $ field :: NAME => Ok (Field :: $ field)) , * , crate :: prisma :: states :: chain :: NAME => Ok (Field :: chain) , crate :: prisma :: states :: indexed_type :: NAME => Ok (Field :: indexed_type) , crate :: prisma :: states :: indexed_block :: NAME => Ok (Field :: indexed_block) , _ => Err (:: serde :: de :: Error :: unknown_field (value , FIELDS)) , } } } deserializer . deserialize_identifier (FieldVisitor) } } struct DataVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for DataVisitor { type Value = Data ; fn expecting (& self , formatter : & mut std :: fmt :: Formatter) -> std :: fmt :: Result { formatter . write_str ("struct Data") } fn visit_map < V > (self , mut map : V) -> Result < Data , V :: Error > where V : :: serde :: de :: MapAccess < 'de > , { $ (let mut $ field = None ;) * let mut chain = None ; let mut indexed_type = None ; let mut indexed_block = None ; while let Some (key) = map . next_key () ? { match key { Field :: chain => { if chain . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: states :: chain :: NAME)) ; } chain = Some (map . next_value () ?) ; } Field :: indexed_type => { if indexed_type . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: states :: indexed_type :: NAME)) ; } indexed_type = Some (map . next_value () ?) ; } Field :: indexed_block => { if indexed_block . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: states :: indexed_block :: NAME)) ; } indexed_block = Some (map . next_value () ?) ; } $ (Field :: $ field => { if $ field . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: states :: $ field :: NAME)) ; } $ field = Some (map . next_value () ?) ; }) * } } $ (let $ field = $ field . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: states :: $ field :: NAME)) ? ;) * let chain = chain . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: states :: chain :: NAME)) ? ; let indexed_type = indexed_type . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: states :: indexed_type :: NAME)) ? ; let indexed_block = indexed_block . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: states :: indexed_block :: NAME)) ? ; Ok (Data { chain , indexed_type , indexed_block , $ ($ field) , * }) } } const FIELDS : & 'static [& 'static str] = & ["chain" , "indexed_type" , "indexed_block"] ; deserializer . deserialize_struct ("Data" , FIELDS , DataVisitor) } } $ ($ (pub mod $ field { crate :: prisma :: states :: $ selection_mode ! (@ field_module ; $ field : $ selection_mode { $ ($ selections) + }) ; }) ?) + } ; (@ field_type ; $ field : ident $ ($ tokens : tt) *) => { compile_error ! (stringify ! (Cannot include nonexistent relation $ field on model "States" , available relations are "")) } ; (@ field_module ; $ ($ tokens : tt) *) => { } ; (@ selection_field_to_selection_param ; $ ($ tokens : tt) *) => { compile_error ! (stringify ! ($ ($ tokens) *)) } ; (@ selections_to_params ; : $ macro_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { [$ (crate :: prisma :: states :: $ macro_name ! (@ selection_field_to_selection_param ; $ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) ,) +] } ; (@ filters_to_args ;) => { vec ! [] } ; (@ filters_to_args ; $ ($ t : tt) *) => { $ ($ t) * } ; (@ field_serde_name ; chain) => { "chain" } ; (@ field_serde_name ; indexed_type) => { "indexed_type" } ; (@ field_serde_name ; indexed_block) => { "indexed_block" } ; }
    pub use _include_states as include;
    pub enum IncludeParam {
        Chain(chain::Include),
        IndexedType(indexed_type::Include),
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_states { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: states struct $ struct_name { # [serde (rename = "chain")] pub chain : crate :: prisma :: Chain , # [serde (rename = "indexed_type")] pub indexed_type : crate :: prisma :: IndexedType , # [serde (rename = "indexed_block")] pub indexed_block : i64 } [$ ($ scalar_field) , +] } } ; }
    pub use _partial_unchecked_states as partial_unchecked;
    #[derive(Debug, Clone, :: serde :: Serialize, :: serde :: Deserialize)]
    pub struct Data {
        #[serde(rename = "chain")]
        pub chain: super::Chain,
        #[serde(rename = "indexed_type")]
        pub indexed_type: super::IndexedType,
    ...
    pub enum SetParam {
        ...
        SetIndexedType(super::IndexedType),
        SetIndexedBlock(i64),
    ...
    impl From<SetParam> for (String, ::prisma_client_rust::PrismaValue) {
        fn from(param: SetParam) -> Self {
            match param {
                ...
                SetParam::SetIndexedType(value) => (
                    indexed_type::NAME.to_string(),
                    ::prisma_client_rust::PrismaValue::Enum(value.to_string()),
                ),
    ...
    impl From<UncheckedSetParam> for SetParam {
        fn from(param: UncheckedSetParam) -> Self {
            match param {
                ...
                UncheckedSetParam::IndexedType(value) => Self::SetIndexedType(value),
    ...
    pub enum OrderByParam {
        ...
        IndexedType(::prisma_client_rust::Direction),
    ...
    pub enum WhereParam {
        ...
        Or(Vec<WhereParam>),
        And(Vec<WhereParam>),
        ChainIndexedTypeEquals(crate::prisma::Chain, crate::prisma::IndexedType),
        Chain(_prisma::read_filters::ChainFilter),
        IndexedType(_prisma::read_filters::IndexedTypeFilter),
    ...
    impl ::prisma_client_rust::WhereInput for WhereParam {
        fn serialize(self) -> ::prisma_client_rust::SerializedWhereInput {
            let (name, value) = match self {
                ...
                Self::ChainIndexedTypeEquals(chain, indexed_type) => (
                    "chain_indexed_type",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![
                        (
                            chain::NAME.to_string(),
                        ...
                        (
                            indexed_type::NAME.to_string(),
                            ::prisma_client_rust::PrismaValue::Enum(indexed_type.to_string()),
                        ),
                    ]),
                ),
                Self::Chain(value) => (chain::NAME, value.into()),
                Self::IndexedType(value) => (indexed_type::NAME, value.into()),
    ...
    impl From<UniqueWhereParam> for WhereParam {
        fn from(value: UniqueWhereParam) -> Self {
            match value {
                UniqueWhereParam::ChainIndexedTypeEquals(chain, indexed_type) => {
                    Self::ChainIndexedTypeEquals(chain, indexed_type)
                }
            }
        }
    ...
    impl ::prisma_client_rust::ModelTypes for Types {
        ...
        fn scalar_selections() -> Vec<::prisma_client_rust::Selection> {
            vec![
                ...
                ::prisma_client_rust::sel(indexed_type::NAME),
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create_many(
            self,
            data: Vec<(super::Chain, super::IndexedType, i64, Vec<SetParam>)>,
        ) -> CreateMany<'a> {
            let data = data
                .into_iter()
                .map(|(chain, indexed_type, indexed_block, mut _params)| {
                    _params.extend([
                        chain::set(chain),
                        indexed_type::set(indexed_type),
                        indexed_block::set(indexed_block),
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (chain, indexed_type, indexed_block, mut _params): (
                super::Chain,
                super::IndexedType,
                i64,
                Vec<SetParam>,
...
pub mod _prisma {
    ...
    impl PrismaClient {
        ...
        pub fn states(&self) -> super::states::Actions {
            super::states::Actions { client: &self.0 }
        }
    ...
    #[derive(Debug, Clone, Copy, :: serde :: Serialize, :: serde :: Deserialize, PartialEq, Eq)]
    pub enum StatesScalarFieldEnum {
        #[serde(rename = "chain")]
        Chain,
        #[serde(rename = "indexed_type")]
        IndexedType,
    ...
    impl ToString for StatesScalarFieldEnum {
        fn to_string(&self) -> String {
            match self {
                Self::Chain => "chain".to_string(),
                Self::IndexedType => "indexed_type".to_string(),
    ...
    pub mod read_filters {
        ...
        #[derive(Clone)]
        pub enum IndexedTypeFilter {
            Equals(super::super::IndexedType),
            InVec(Vec<super::super::IndexedType>),
            NotInVec(Vec<super::super::IndexedType>),
            Not(super::super::IndexedType),
        }
        impl Into<::prisma_client_rust::SerializedWhereValue> for IndexedTypeFilter {
            fn into(self) -> ::prisma_client_rust::SerializedWhereValue {
                match self {
                    Self::Equals(value) => {
                        ::prisma_client_rust::SerializedWhereValue::Object(vec![(
